...
import { getPrizeTiers, savePrizeTiers, resetPrizeStock } from '../utils/dataStore'
          ...
          return (
            ...
            >
              <div className="mb-3 flex items-start gap-3">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-lg bg-brand-navy text-lime-400">
                  <Icon size={24} />
                </div>
                <input
                  value={tier.label}
              ...
              <div className="flex flex-wrap items-center justify-between gap-3">
                <div>
                  <label className="mb-1 block text-xs font-semibold text-ink-medium">Ícone</label>
                  <select
